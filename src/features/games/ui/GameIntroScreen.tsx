...
const styles = StyleSheet.create({
  root: { flex: 1, minHeight: 0, position: 'relative', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 20, paddingHorizontal: 58, paddingVertical: 16 },
  ...
  step: { flex: 1, minHeight: 62, padding: 8, flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(255,253,243,0.93)' },
  ...
  learningLine: { marginTop: 7, borderRadius: 12, backgroundColor: 'rgba(7,79,54,0.90)', paddingHorizontal: 10, paddingVertical: 7 },
  ...
  footerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginTop: 8 },
