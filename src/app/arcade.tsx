...
const styles = StyleSheet.create({
  ...
  topRow: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  heading: { alignSelf: 'center', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 16, backgroundColor: 'rgba(4,54,36,0.76)' },
  headingTitle: { color: colors.white, fontSize: 14, lineHeight: 16, fontWeight: '900' },
  headingSub: { color: '#DDEED7', fontSize: typography.micro, lineHeight: 12, fontWeight: '700' },
